...
import com.example.justweddingpro.databinding.ActivityCreateCaptainBinding
...
class CreateCaptainActivity : BasedActivity() {
    private lateinit var binding: ActivityCreateCaptainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCreateCaptainBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.headerview.headerTitle.text = "Create Captain"
        ...
        pickImageLauncher =
            registerForActivityResult(ActivityResultContracts.GetContent()) { uri: Uri? ->
                uri?.let {
                    ...
                    ImageUrlEncoder = getRealPathFromURI(it, this@CreateCaptainActivity)!!
                }
            }
    ...
    private fun mApiAddEventMenu() {
        CommonUtils.showProgressDialog(this@CreateCaptainActivity)
        ...
        mAddUserRequest.setClientCategory("Captain")
